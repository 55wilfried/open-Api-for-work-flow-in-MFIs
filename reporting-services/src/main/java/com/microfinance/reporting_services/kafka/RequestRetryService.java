package com.microfinance.reporting_services.kafka;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.microfinance.reporting_services.models.FailedRequest;
...
public class RequestRetryService {
    ...
    @Autowired
    private ReportingServices clientServices;
    ...
    @KafkaListener(topics = "failed-requests", groupId = "reporting-service-group")
    ...
    @KafkaListener(topics = "success-requests", groupId = "reporting-service-group")
