package com.microfinance.transaction_services.kafka;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.microfinance.transaction_services.models.FailedRequest;
...
public class RequestRetryService {
    ...
    @Autowired
    private TransactionServices clientServices;
    ...
    @KafkaListener(topics = "failed-requests", groupId = "transaction-service-group")
    ...
    @KafkaListener(topics = "Success-requests", groupId = "transaction-service-group")
